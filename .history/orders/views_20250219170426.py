...
def place_bid(request, part_request_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            bid.save()
            return render(request, 'orders/part_request_list.html', {'part_request': part_request})
...
class BidDetailView(DetailView):
    model = Bid
    template_name = "bids/bid_detail_view.html"
    context_object_name = "bid"
...
class BidDeleteView(DeleteView):
    model = Bid
    template_name = "bids/bid_confirm_delete.html"
